...
#def test12():
   # output= list(map(lambda x,y: [x,y], list_id,list_dit))
    #print(output)
    #return str(output)
                ...
                if len(outputs[i]) > 0:
                    for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                        ...
                        if frame_idx >= 1 and id in prev:
                            ...
                            global list_dic_id, list_dic_dis
                            list_dic_id = list(dist_dict.keys())
                            list_dic_dis = list(dist_dict.values())
                        ...
                        bbox_x = (output[2] + output[0])/2
                        bbox_y = (output[3] - output[1])/2
                        # Write MOT compliant results to file
                        if save_vid or save_crop or show_vid or show_browser:  # Add bbox to image
